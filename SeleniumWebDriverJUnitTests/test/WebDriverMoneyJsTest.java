...
public class WebDriverMoneyJsTest {
    ...
    public void createDriver() {
    	System.setProperty("webdriver.chrome.driver", "C:\\Users\\NOM\\Desktop\\Med\\oti\\SeleniumWebDriverJUnitTests/chromedriver.exe");
    ...
    @Test
    public void test_add_OK() throws java.io.IOException{
        driver.get("http://localhost:63342/money_js/src/index.html");

        WebElement element = driver.findElement(By.id("v1"));
        element.sendKeys("1");

        element = driver.findElement(By.id("c1"));
        element.sendKeys("EUR");

        element = driver.findElement(By.id("v2"));
        element.sendKeys("1");

        element = driver.findElement(By.id("c2"));
        element.sendKeys("EUR");
    ...
    @Test
    public void test_add_not_same_currency() throws java.io.IOException{
        driver.get("http://localhost:63342/money_js/src/index.html");
        ...
        File scrFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        FileUtils.copyFile(scrFile, new File("/tmp/screenshot_not_same_currency.jpg"));

        assertEquals(driver.findElement(By.id("res")).getText(),"incompatible currency : EUR with DHR");
        new File("/tmp/screenshot_not_same_currency.jpg").delete();
    ...
    public void test_sub_not_same_devise() throws java.io.IOException{
        ...
        assertEquals(driver.findElement(By.id("res")).getText(),"incompatible currency : CHF with EUR");
    ...
    public void test_sub_err_value_neg() throws java.io.IOException{
        ...
        assertEquals(driver.findElement(By.id("res")).getText(),"Negatif value: 6 with 8");
