...
public class MoneySubTestCase {
    ...
    public void TestsimpleSubValueNegatif() throws UnexistingCurrencyException, IncompatibleSubException {
        MoneyOps.simpleSub(f12EUR, f14EUR);
    }

    @Test(expected = IncompatibleCurrencyException.class)
    public void TestsimpleSubNotSameDivise() throws UnexistingCurrencyException, IncompatibleSubException {
